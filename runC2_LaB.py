...
# ---------------- PROMPT ----------------
def build_prompt(question, options_dict, topic):
    options_text = ""
    ...
    return (
        "Instruction: Solve the multiple choice question using your knowledge about {topic}. "
    ...
    for csv_file in os.listdir(BENCHMARK_DIR):
        ...
        for model_path in LLMs:
            ...
            for label, questions in all_cases.items():  # separate files per label
                ...
                os.system("pkill -9 -f python runC2_LaB.py")
